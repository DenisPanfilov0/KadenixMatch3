...
public partial class Contexts {
    ...
    public const string BoardPosition = "BoardPosition";
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, UnityEngine.Vector2Int>(
            BoardPosition,
            game.GetGroup(GameMatcher.BoardPosition),
            (e, c) => ((Code.Gameplay.Common.BoardPosition)c).Value));
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithBoardPosition(this GameContext context, UnityEngine.Vector2Int Value) {
        return ((Entitas.EntityIndex<GameEntity, UnityEngine.Vector2Int>)context.GetEntityIndex(Contexts.BoardPosition)).GetEntities(Value);
    }
